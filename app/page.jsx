    ...
    <div className="bg-black overflow-x-hidden">
        ...
        <div className="col-span-full lg:col-span-3 flex flex-col items-center justify-center text-center lg:-rotate-2">
          ...
          <div className="relative flex items-center justify-center gap-3 sm:gap-4 mt-8 sm:mt-16">
            ...
            <p className="text-sm text-stone-400 text-center sm:text-left">
              ...
              cracked FAANG interviews via InterVu
            </p>
          </div>
        </div>
      ...
      <section className="relative z-10 pb-28 max-w-5xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-6 ">
          {ROLES.map(role => (
            <div key={role.label} className="relative bg-[#0f0f11] border border-white/10
            hover:border-amber-400/40 rounded-2xl p-12 h-full transition duration-300 overflow-hidden">
      ...
      <section className = "relative z-10 pb-28 max-w-5xl mx-auto px-6">
        ...
        <p className = "relative text-stone-400 font-light text-sm mb-11">
          join thousands of engineers already levelling up on InterVu.
        </p>
