  ...
  if (!availability) {
    return (
      <div className="bg-[#0f0f11] border border-white/10 rounded-2xl p-8 text-center flex flex-col items-center gap-2">
        ...
        <p className="text-sm text-stone-400">No availability set yet.</p>
    ...
    <>
      ...
      <div className="flex flex-col gap-4 ">
        ...
        <div className="bg-[#0f0f11] border border-white/10 rounded-2xl p-7 flex flex-col gap-6">
          ...
          {/* Date Tabs */}
          <div className="flex gap-2 overeflow-x-auto pb-0.5 scrollbar-none -mx-1 px-1">
            {dates.map((date) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={`mt-0.5 ${active ? "text-amber-500/70" : "text-stone-600"
                      }`}
                  >
                    {label.bottom}
                  </span>
