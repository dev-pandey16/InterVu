      ...
      <div className="w-full max-w-2xl">
        <div className="text-center mb-10">
          ...
          <h1 className="font-serif text-5xl leading-tight tracking-tighter mt-1">
            ...
            <br />
            <GoldTitle>using InterVu?</GoldTitle>
          </h1>
        ...
        {!role && (<div className="grid grid-cols-2 gap-4 w-full">
          {ONBOARDING_ROLES.map(r => (
            <button
              key={r.value}
              type='button'
              onClick={() => setRole(r.value)}
              className="text-left rounded-2xl p-8 border border-white/10 bg-[#0f0f11] hover:border-amber-400/40 hover:-translate-y-0.5 transition-all duration-300"
            >
              <span className="w-11 h-11 rounded-xl bg-amber-400/10 border border-amber-400/30 flex items-center justify-center text-xl mb-5">
                {r.icon}
              </span>
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-center justify-between bg-[#0f0f11] border border-white/10 rounded-2xl px-6 py-4">
              <div className="flex items-center gap-3">
                <span className="w-9 h-9 rounded-xl bg-amber-400/10 border border-amber-400/30 flex items-center justify-center text-base shrink-0">
